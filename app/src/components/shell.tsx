...
export const MODULES = [
  ...
  },
  {
    ...
    ready: false,
    items: [
      { href: "#", label: "Customers", icon: "shop" as const },
      { href: "#", label: "Products", icon: "box" as const },
      { href: "#", label: "Sales orders", icon: "doc" as const },
    ],
  },
  {
    name: "Later",
    ready: false,
    items: [
      { href: "#", label: "Permits & documents", icon: "shield" as const },
      { href: "#", label: "Leave & advances", icon: "wallet" as const },
    ],
  },
] as const;
